...
const AddClasses = () => {
    ...
    const onSubmit = (data) => {
        ...
        fetch('http://localhost:5000/classes/submit', {
            method: 'POST',
            headers: {
        ...
        <div className="w-full m-4">
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control w-full ml-4">
                        ...
                        <input type="text" {...register("imageURL", { required: true })} placeholder="imageURL" className="input input-bordered w-full " />
                    </div>
                <div className="grid md:grid-cols-2 gap-2 my-4">
                    ...
                    <div className="form-control w-full ml-4">
                        ...
                        placeholder="instructorName" className="input input-bordered w-full " />
                    </div>
                    <div className="form-control w-full ml-4">
                        <label className="label">
                    ...
                    <div className="form-control w-full ml-4">
                        ...
                        <input type="text" {...register("photoURL", { required: true })}  defaultValue={user?.photoURL} placeholder="instructor photo" className="input input-bordered w-full " />
                    </div>
                    <div className="form-control w-full ml-4">
                        <label className="label">
                    ...
                    <div className="form-control w-full ml-4">
                        ...
                        <input type="number" {...register("Total_seats", { required: true })} placeholder="Total_seats" className="input input-bordered w-full " />
                    </div>
                    <div className="form-control w-full ml-4">
                        <label className="label">
                            <span className="label-text font-semibold">availableSeats</span>
                        </label>
                        <input type="number" {...register("availableSeats", { required: true })} placeholder="availableSeats" className="input input-bordered w-full " />
                    </div>
                </div>
                ...
                <input className="btn bg-orange-400 font-bold mt-4" type="submit" value="Add Classes" />
            </form>
        </div>
    );
};
